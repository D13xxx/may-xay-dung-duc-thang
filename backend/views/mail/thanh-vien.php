    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    <div class="profile-image">
                        <img src="/theme/assets/images/users/user3.jpg" alt="Nadia Ali">
                    </div>
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    <div class="profile-image">
                        <img src="/theme/assets/images/users/user.jpg" alt="Dmitry Ivaniuk">
                    </div>
                    <div class="profile-data">
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    <div class="profile-image">
                        <img src="/theme/assets/images/users/user2.jpg" alt="John Doe">
                    </div>
                    <div class="profile-data">
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    <div class="profile-image">
                        <img src="/theme/assets/images/users/user4.jpg" alt="Brad Pitt">
                    </div>
                    <div class="profile-data">
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    <div class="profile-image">
                        <img src="/theme/assets/images/users/user5.jpg" alt="John Travolta">
                    </div>
                    <div class="profile-data">
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    <div class="profile-image">
                        <img src="/theme/assets/images/users/user6.jpg" alt="Darth Vader">
                    </div>
                    <div class="profile-data">
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    <div class="profile-image">
                        <img src="/theme/assets/images/users/user7.jpg" alt="Samuel Leroy Jackson">
                    </div>
                    <div class="profile-data">
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    <div class="profile-image">
                        <img src="/theme/assets/images/users/no-image.jpg" alt="Samuel Leroy Jackson">
                    </div>
                    <div class="profile-data">
