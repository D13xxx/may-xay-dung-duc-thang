...
use common\models\query\CoiThiQuery;
use common\models\query\KsDotNguoiKhaoSatQuery;
use common\models\query\NguoiKhaoSatSearch;
...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $canBo = CanBo::findByMa(Yii::$app->user->identity->username);
//        echo $canBo->id;exit();
        $searchModel = new CoiThiQuery();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->where(['can_bo_id'=>$canBo->id]);
//            $dataProvider->query->orderBy([''=>SORT_DESC]);
        $searchModel2 = new KsDotNguoiKhaoSatQuery();
        $dataProvider2 = $searchModel2->search(Yii::$app->request->queryParams);
        $dataProvider2->query->where(['can_bo_id'=>$canBo->id]);
        $dataProvider2->query->orderBy(['id'=>SORT_DESC]);
