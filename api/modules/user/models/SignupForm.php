...
class SignupForm extends Model
{
    ...
    public function signup()
    {
        if ($this->validate()) {
            ...
            $user->status = $shouldBeActivated ? CanBoUser::STATUS_NOT_ACTIVE : CanBoUser::STATUS_ACTIVE;
            ...
            if ($shouldBeActivated) {
                $token = CanBoUserToken::create(
                    $user->id,
                    CanBoUserToken::TYPE_ACTIVATION,
